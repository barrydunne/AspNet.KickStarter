...
internal class AddInHealthHandlerTests
{
    ...
    public AddInHealthHandlerTests() => _fixture = new Fixture();
    ...
    public void AddInHealthHandler_adds_services()
    {
        ...
        Assert.That(serviceCollection, Has.Some.Matches<ServiceDescriptor>(_ => (_.ImplementationType == typeof(HealthHandler) && (_.Lifetime == ServiceLifetime.Transient))), "HealthHandler not registered.");

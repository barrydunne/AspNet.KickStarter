...
try {
    ...
    reportgenerator -reports:'tests/TestResults/aiadc.xml;tests/TestResults/aiapc.xml;tests/TestResults/aie.xml;tests/TestResults/aifv.xml;tests/TestResults/aihh.xml;tests/TestResults/aim.xml;tests/TestResults/aiot.xml;tests/TestResults/aisl.xml;tests/TestResults/aisv.xml;tests/TestResults/aisw.xml;tests/TestResults/core.xml;tests/TestResults/core.xml;tests/TestResults/cqrs.xml;tests/TestResults/tr.xml' -targetdir:tests/TestResults/CoverageReport -reporttypes:Html_Dark
